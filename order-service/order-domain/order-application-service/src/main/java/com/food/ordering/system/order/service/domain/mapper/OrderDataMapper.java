...
public class OrderDataMapper {
    ...
    public Restaurant createOrderCommandToRestaurant(CreateOrderCommand createOrderCommand){
        return Restaurant.builder().id(new RestaurantId(createOrderCommand.getRestaurantId()))
    ...
    private List<com.food.ordering.system.order.domain.entity.OrderItem> orderItemsToOrderItemEntities (List<OrderItem> orderItems){
        return orderItems.stream()
                .map(orderItem ->
                        com.food.ordering.system.order.domain.entity.OrderItem.builder()
